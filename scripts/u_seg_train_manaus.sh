...
python3 pytorch-unsupervised-segmentation-tip/demo.py --visualize 0 --datapath /home/brics/public/brics_data/Manaus/manaus/raw/images/  --database_masks Manaus --seed_target 512
